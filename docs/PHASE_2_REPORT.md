...
- Add Product supports deliberate manufacturer-code entry and camera capture through the shared production scanner. Hardware scanning and unknown-barcode recovery remain centered in Phase 3 sale entry.
