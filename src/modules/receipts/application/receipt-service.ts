...
export async function initializeReceiptUpload(userId: string, origin: string, raw: unknown) {
  const rate = consumeRateLimit(`receipt-upload:${userId}`, 20, 60_000);
