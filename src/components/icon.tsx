const paths = {
  ...
  eyeOff: (
    <>
      <path d="m3 3 18 18" />
      <path d="M10.6 6.15A10.8 10.8 0 0 1 12 6c6 0 9.5 6 9.5 6a16.7 16.7 0 0 1-2.1 2.8M6.25 6.25C3.85 8 2.5 12 2.5 12s3.5 6 9.5 6a9.7 9.7 0 0 0 3.2-.55" />
      <path d="M10.05 10.05a2.75 2.75 0 0 0 3.9 3.9" />
    </>
  ),
  loader: (
    <>
